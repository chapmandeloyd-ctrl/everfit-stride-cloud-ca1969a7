      ...
      try {
        const aiResponse = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
          ...
          body: JSON.stringify({
            ...
            messages: [
              { role: "system", content: "You are APEXBEAST-IF, a supportive keto nutrition coach. Be warm but direct. Keep responses to 2 sentences max. Sound like a real coach texting their client, not a robot." },
