...
Deno.serve(async (req) => {
  ...
  const candidates: Array<[string, unknown]> = [
    ...
    // ── Workouts / training ──
    ['/workout/getList', { userid, count: 20 }],
    ['/workout/get', { userid }],
    ['/workoutSession/getList', { userid, startDate: '2025-01-01', endDate, count: 100 }],
    ['/workoutSession/getList (no dates)', { userid, count: 50 }],
    ['/workoutSession/get', { userid }],
    ['/trainingSession/getList', { userid, startDate: '2025-01-01', endDate }],
    ['/trainingPlan/getList', { userid }],
    ['/trainingPlan/get', { userid }],
    ['/trainingProgram/getList', { userid }],
    ['/program/getList', { userid }],
    ['/schedule/getList', { userid, startDate: '2025-01-01', endDate }],
    ['/calendar/getList', { userid, startDate: '2025-01-01', endDate }],
    ['/exerciseLog/getList', { userid, startDate: '2025-01-01', endDate }],
    ['/exerciseSet/getList', { userid, startDate: '2025-01-01', endDate }],
    ['/personalRecord/getList', { userid }],
    ['/pr/getList', { userid }],
    // ── Habits / challenges / messages ──
    ['/habit/getList', { userid }],
    ['/habit/getListStats', { userid, startDate: '2025-01-01', endDate }],
    ['/habitLog/getList', { userid, startDate: '2025-01-01', endDate }],
    ['/habitTracker/getList', { userid }],
    ['/challenge/getList', { userid }],
    ['/challenge/getListStats', { userid }],
    ['/challengeEntry/getList', { userid }],
    ['/leaderboard/getList', { userid }],
    ['/task/getList', { userid }],
    ['/todo/getList', { userid }],
    ['/message/getList', { userid, count: 20 }],
    ['/note/getList', { userid }],
  ];
