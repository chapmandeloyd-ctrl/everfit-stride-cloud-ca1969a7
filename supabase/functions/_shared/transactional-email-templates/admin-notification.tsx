...
const AdminNotificationEmail = ({ subject, bodyHtml }: AdminNotificationProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>{subject || 'You have a new notification from APEXBEAST-IF'}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={footer}>© {new Date().getFullYear()} APEXBEAST-IF. All rights reserved.</Text>
      </Container>
    </Body>
  </Html>
)
...
export const template = {
  ...
  subject: (data: Record<string, any>) => data.subject || 'Notification from APEXBEAST-IF',
