...
const WelcomeGettingStartedEmail = ({ name, loginUrl }: WelcomeGettingStartedProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Here's how to get started with APEXBEAST-IF</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="APEXBEAST-IF" width="80" height="80" style={logo} />
        <Heading style={h1}>Let's Get Started! 🚀</Heading>
        <Text style={text}>
          {name ? `Hey ${name}, welcome` : 'Welcome'} to APEXBEAST-IF! Here's a quick guide to help you hit the ground running:
        </Text>
