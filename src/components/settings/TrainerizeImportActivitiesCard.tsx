  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Pull completed workouts and cardio from Trainerize into APEXBEAST-IF. Imported activities show in each client's history alongside APEX sessions, tagged as "Trainerize". Re-runs are safe — duplicates are skipped.
        </CardDescription>
      </CardHeader>
