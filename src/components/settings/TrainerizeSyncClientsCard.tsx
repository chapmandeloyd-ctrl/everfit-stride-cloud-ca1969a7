    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Matches your Trainerize roster to APEXBEAST-IF clients by email and links them.
          ...
          {result?.ok ? (
            <div className="space-y-4">
              ...
              {result.newClients && result.newClients.length > 0 && (
                <div>
                  <h4 className="text-sm font-semibold mb-2">Link Trainerize clients to APEXBEAST-IF</h4>
