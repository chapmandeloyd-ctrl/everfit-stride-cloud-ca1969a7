...
const QUICK_TEMPLATES: QuickTemplate[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "3", type: "button", content: "Open Dashboard", url: "https://apexbeast-if.app/client/dashboard", alignment: "center" },
    ],
  },
  {
    id: "workout-reminder",
    ...
    blocks: [
      ...
      { id: "3", type: "button", content: "Start Workout", url: "https://apexbeast-if.app/client/dashboard", alignment: "center" },
    ],
  },
  {
    id: "milestone",
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "3", type: "button", content: "View Meal Plan", url: "https://apexbeast-if.app/client/dashboard", alignment: "center" },
    ],
  },
  {
    id: "welcome-back",
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "3", type: "button", content: "Reply to Coach", url: "https://apexbeast-if.app/client/messages", alignment: "center" },
    ],
  },
];
          ...
          >
            <CardContent className="p-4 space-y-3">
              <div className="flex items-start gap-3">
                <img src={LOGO_URL} alt="APEXBEAST-IF" className="h-10 w-10 shrink-0 rounded-lg" />
