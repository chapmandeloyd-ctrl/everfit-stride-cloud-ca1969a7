  ...
  return (
    <div className={cn(
      ...
      <div className="bg-muted/50 px-4 py-3 border-b border-border">
        <p className="text-xs text-muted-foreground">From: APEXBEAST-IF &lt;noreply@apexbeast-if.app&gt;</p>
      ...
      <div className="p-6 space-y-4 bg-white">
        ...
        <div className="text-center pb-2">
          <img src="https://eexxmfuknqttujecbcho.supabase.co/storage/v1/object/public/email-assets/logo.png" alt="APEXBEAST-IF" className="h-16 w-16 mx-auto" />
        </div>
