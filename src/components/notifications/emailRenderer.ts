...
<img src="${LOGO_URL}" alt="APEXBEAST-IF" width="80" height="80" style="display:block;margin:0 auto" />
</div>
${blockHtml}
<div style="margin-top:32px;padding-top:16px;border-top:1px solid #e5e5e5;text-align:center">
<p style="font-size:12px;color:#999999;margin:0;font-family:'Space Grotesk',Arial,sans-serif">© ${new Date().getFullYear()} APEXBEAST-IF. All rights reserved.</p>
</div>
</div>
</body>
</html>`;
