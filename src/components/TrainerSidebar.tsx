...
const mainItems = [
  ...
  { title: "Data Console", url: "/admin/data", icon: Database },
];
      ...
      <SidebarContent>
        <div className="p-4 border-b border-sidebar-border" style={{ paddingTop: 'max(env(safe-area-inset-top, 0px), 16px)' }}>
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="APEXBEAST-IF" className="h-16 w-16 rounded-xl object-cover" />
            {open && (
              <div>
                <h2 className="font-bold text-sidebar-foreground">APEXBEAST-IF</h2>
