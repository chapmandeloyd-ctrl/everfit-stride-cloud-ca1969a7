...
export default function FirstWeekStep({
  ...
  return (
    <div className="flex h-full flex-col gap-5">
      <div>
        <div className="text-xs uppercase tracking-[0.25em] text-white/50">Your first week</div>
        <h2 className="mt-1 text-2xl font-semibold tracking-tight">A clear, simple start</h2>
      </div>
      ...
      <div className="space-y-2.5">
        {items.map(({ Icon, label, value }, i) => (
          <div
            key={label}
            className="relative flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4"
          >
      ...
      <div className="rounded-2xl border border-[hsl(174_72%_50%/0.3)] bg-[hsl(174_72%_50%/0.06)] p-4">
        <div className="text-xs uppercase tracking-[0.25em] text-[hsl(174_72%_60%)]">Expected benefits</div>
