...
export default function OnboardingShell({
  ...
  return (
    <div className="dark onboarding-scroll-scope relative flex h-[100dvh] flex-col overflow-hidden bg-[hsl(0_0%_4%)] text-[hsl(0_0%_96%)]">
      ...
      {/* Top bar */}
      <div className="relative z-10 flex shrink-0 items-center gap-3 px-4 pt-[max(env(safe-area-inset-top),0.75rem)] pb-2">
        {onBack ? (
          <button
            onClick={onBack}
      ...
      <div className="relative z-10 mx-auto flex w-full min-h-0 flex-1 max-w-md flex-col px-4 pb-[max(env(safe-area-inset-bottom),1rem)] pt-3">
