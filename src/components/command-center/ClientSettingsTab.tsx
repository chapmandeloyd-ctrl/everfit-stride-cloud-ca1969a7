      ...
      <Card>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input
              value={(settings as any)?.fasting_card_subtitle ?? "Fasting is the foundation of your APEXBEAST-IF plan."}
              onChange={(e) => toggleMutation.mutate({ key: "fasting_card_subtitle", value: e.target.value })}
              placeholder="Fasting is the foundation of your APEXBEAST-IF plan."
              className="max-w-sm"
            />
          </div>
