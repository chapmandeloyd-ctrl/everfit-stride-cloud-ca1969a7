          ...
          <div className="rounded-lg bg-black/20 px-3 py-2.5">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2 min-w-0">
                {share ? (
                  <Share2 className="h-3.5 w-3.5 text-white/70 shrink-0" />
                ) : (
                  <Lock className="h-3.5 w-3.5 text-white/70 shrink-0" />
                )}
                <span className="text-xs font-semibold text-white/90">
                  {share ? "Share with coach" : "Private"}
                </span>
              </div>
            ...
            <p className="text-[10px] text-white/50 mt-1 leading-snug">
              {share
                ? "Your coach will see your mood, motivation and note for today."
                : "Only you can see this entry. Toggle on to share with your coach."}
            </p>
          </div>
