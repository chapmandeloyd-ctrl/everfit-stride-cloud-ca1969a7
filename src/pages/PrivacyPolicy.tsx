      ...
      <div className="border-b border-border">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg">APEX360-IF Privacy Policy</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Welcome to APEX360-IF ("we," "our," or "us"). APEX360-IF is a fitness coaching platform
          ...
          <p className="text-muted-foreground leading-relaxed">
            By using APEX360-IF, you agree to the terms of this Privacy Policy. If you do not agree,
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-2">
            <li>To provide, operate, and improve the APEX360-IF platform</li>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            APEX360-IF is not intended for children under the age of 13. We do not knowingly collect
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            significant changes by email or through the platform. Continued use of APEX360-IF after
