      ...
      <div className="border-b border-border">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg">APEXBEAST-IF Privacy Policy</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Welcome to APEXBEAST-IF ("we," "our," or "us"). APEXBEAST-IF is a fitness coaching platform
          ...
          <p className="text-muted-foreground leading-relaxed">
            By using APEXBEAST-IF, you agree to the terms of this Privacy Policy. If you do not agree,
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-2">
            <li>To provide, operate, and improve the APEXBEAST-IF platform</li>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            APEXBEAST-IF is not intended for children under the age of 13. We do not knowingly collect
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            significant changes by email or through the platform. Continued use of APEXBEAST-IF after
        ...
        <section className="space-y-3">
          ...
          <div className="bg-muted rounded-lg p-4 text-sm text-muted-foreground space-y-1">
            <p className="font-medium text-foreground">APEXBEAST-IF</p>
            <p>Email: <a href="mailto:privacy@apexbeastif.com" className="text-primary underline">privacy@apexbeastif.com</a></p>
            <p>Website: <a href="https://apexbeast-if.app" className="text-primary underline">apexbeast-if.app</a></p>
          </div>
        </section>

        <div className="border-t border-border pt-6 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} APEXBEAST-IF. All rights reserved.
        </div>
      </div>
    </div>
  );
