      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        {state === "valid" && (
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Are you sure you want to unsubscribe from APEXBEAST-IF emails?
            </p>
            <Button
        ...
        {state === "success" && (
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              You won't receive any more emails from APEXBEAST-IF.
            </p>
          </div>
        )}
        ...
        {state === "already" && (
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              You've already unsubscribed from APEXBEAST-IF emails.
            </p>
          </div>
        )}
