  ...
  return (
    <ClientLayout>
      <div className="pb-8 w-full">
        ...
        {/* ═══════════════════════════════════════════ */}
        {/* PART 1 — YOUR APEXBEAST-IF PLAN (Protocol Hero)    */}
        {/* ═══════════════════════════════════════════ */}
          ...
          <Card className="overflow-hidden" style={{ backgroundColor: "hsl(var(--primary) / 0.06)", borderColor: "hsl(var(--primary) / 0.2)" }}>
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[11px] font-extrabold uppercase tracking-[0.15em] text-primary">Your APEXBEAST-IF Plan</span>
              </div>
            ...
            <div className="px-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  { label: "System", value: "APEXBEAST-IF" },
