                ...
                <>
                  <div
                    ...
                    onTouchEnd={workoutType === "superset" ? handleBlockTouchEnd : undefined}
                     className={`border rounded-lg overflow-hidden transition-all border-border bg-border ${blockDragIndex === blockIdx ? "opacity-50 scale-95" : ""} ${blockOverIndex === blockIdx && blockDragIndex !== null && blockDragIndex !== blockIdx ? "border-t-2 border-t-primary" : ""}`}
                   >
                     {/* Group header */}
                     <div className="flex items-center gap-2 px-3 py-3 bg-border">
