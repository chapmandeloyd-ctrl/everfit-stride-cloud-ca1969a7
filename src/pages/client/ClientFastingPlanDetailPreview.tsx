    ...
    if (planType === "quick" && quickPlan) {
      ...
      return {
        ...
        description:
          ...
          "A curated APEXBEAST-IF fasting window.",
        opensAt,
        closesAt,
      };
    }
    if (planType === "program" && program) {
      ...
      return {
        ...
        description:
          ...
          "A structured APEXBEAST-IF fasting program.",
        opensAt: "10:00 AM",
        closesAt: "8:00 PM",
      };
    }
        ...
        >
          ...
          >
            ...
            <p className="text-sm mb-5" style={{ color: MUTED }}>
              ...
              like to complete your APEXBEAST-IF Synergy program.
            </p>
          ...
          >
            ...
            <p className="text-sm mb-4" style={{ color: MUTED }}>
              {pendingKeto
                ...
                : "By keeping your current keto type, you're updating your fasting protocol only. Your new APEXBEAST-IF Synergy program will be:"}
            </p>
