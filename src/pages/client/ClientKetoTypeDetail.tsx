...
export default function ClientKetoTypeDetail() {
  ...
  // their APEXBEAST-IF Synergy program: a new fasting protocol was just chosen
  ...
  return (
    <ClientLayout>
      ...
      {/* Synergy popup — choose how to complete the APEXBEAST-IF Synergy program */}
      {synergyConfirmOpen && (
        <div
